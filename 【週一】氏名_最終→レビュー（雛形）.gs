function saishuWeekBotPost() {
  ...
  function newMonthStart_() {
    ...
    sheet.getRange(3,3,1,1).setValue(shiftgaiSetForm);
  }
  ...
  function postToSlack_() {
    ...
    var last_day_ave = sheet.getSheetValues(9, 2, 1, 1); 
    let every_hour = sheet.getSheetValues(10, 2, 1, 1); 
    let average_time = sheet.getSheetValues(11, 2, 1, 1);
    let last_time = sheet.getSheetValues(6, 5, 1, 1);
    let total_saishu = sheet.getSheetValues(14, 4, 1, 1); 
    var comment_ave = sheet.getSheetValues(16, 2, 1, 1);
    var comment_ave = comment_ave[0][0].toFixed(2);
    let satisfaction = sheet.getSheetValues(17, 2, 1, 1);
    let lank_score_ave = sheet.getSheetValues(20, 2, 1, 3);
    let lank_every_ave = sheet.getSheetValues(21, 2, 1, 3);
    let lank_comment_ave = sheet.getSheetValues(22, 2, 1, 3);
